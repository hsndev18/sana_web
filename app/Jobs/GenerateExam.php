...
class GenerateExam implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($response->failed()) {
            Log::error('Failed to generate exams for video ' . $this->namespaceId);
            throw new \Exception('Failed to generate exams for video ' . $this->namespaceId);
        }
    }
}
