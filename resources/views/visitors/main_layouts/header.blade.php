                    ...
                    <div class="col-lg-8 d-none d-lg-block">
                        <nav class="mainmenu-nav d-none d-lg-flex justify-content-center">
                            <ul class="mainmenu">
                                ...
                                <li class="with-megamenu has-menu-child-item"><a href="index.html#">Pages <i
                    ...
                    <div class="col-lg-2 col-md-6 col-6 position-static">
                        <div class="header-right">
                            ...
                            <div class="header-btn">
                                <a class="rainbow-gradient-btn" target="_blank" href="text-generator.html"><span>Get
                                        Start</span></a>
                            </div>
                            <!-- End Header Btn  -->
            ...
            <div class="inner-popup">
                ...
                <div class="content">
                    <ul class="mainmenu">
                        ...
                        <li class="has-dropdown has-menu-child-item position-relative"><a href="index.html#">Tools <i
                                    class="fa-regular fa-chevron-down"></i></a>
                            <ul class="submenu">
                                <li>
                                    <a href="text-generator.html">
                    ...
                    <div class="rbt-default-sidebar-wrapper">
                        <nav class="mainmenu-nav">
                            <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                <li><a href="text-generator.html"><i
                                            class="fa-sharp fa-regular fa-monitor"></i><span>Welcome</span></a></li>
                                <li><a href="plans-billing.html"><i
                                            class="fa-sharp fa-regular fa-briefcase"></i><span>Manage
                                            Subsription</span></a></li>
                            </ul>
                            <div class="rbt-sm-separator"></div>
                            <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                <li><a href="text-generator.html"><img src="{{ asset('assets/images/generator-icon/text.png') }}"
                                            alt="AI Generator"><span>Text Generator</span></a></li>
                                <li><a href="image-generator.html"><img src="{{ asset('assets/images/generator-icon/photo.png') }}"
                                ...
                                <li><a href="image-editor.html"><img src="{{ asset('assets/images/generator-icon/photo.png') }}"
                                ...
                                <li><a href="vedio-generator.html"><img
                                            ...
                                            alt="AI Generator"><span>Vedio Generator</span></a></li>
                                <li><a href="email-generator.html"><img src="{{ asset('assets/images/generator-icon/email.png') }}"
                                            alt="AI Generator"><span>Email Generator</span></a></li>
                        ...
                        <nav class="mainmenu-nav">
                            <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                <li class="has-submenu"><a class="collapse-btn collapsed" data-bs-toggle="collapse"
                                        href="index.html#collapseExampleMenu" role="button" aria-expanded="false"
                                ...
                                <li><a href="index.html#"><i class="fa-sharp fa-regular fa-award"></i><span>Help &
                                            FAQ</span></a></li>
                            </ul>
                            <div class="rbt-sm-separator"></div>
                            <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                <li><a href="release-notes.html"><i
                                            class="fa-sharp fa-regular fa-bell"></i><span>Release notes</span></a></li>
                                <li><a href="terms-policy.html"><i
                ...
                <div class="header-btn d-block d-md-none">
                    <a class="btn-default @@btnClass" target="_blank" href="text-generator.html">Get
                        Started Free</a>
                </div>
                <!-- End Header Btn  -->
            </div>
