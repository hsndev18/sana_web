            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-11 col-xl-11 justify-content-center">
                    <div class="slider-frame">
                        <img class="slider-image-effect" src="{{ asset('assets/images/bg/slider-main-image.png') }}"
                            alt="Banner Images">
                    </div>
                </div>
            </div>
                            ...
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle"
                                    ...
                                    aria-selected="false"><span class="generator-icon"><img
                                            ...
                                            alt="Vedio Generator Icon">Vedio Generator</span><span
                            ...
                            <li class="nav-item tabs__tab" role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle active"
                                    ...
                                    aria-selected="true"><span class="generator-icon"><img
                                            ...
                                            alt="Vedio Generator Icon">Audio Generator</span><span
                                        class="border-bottom-style"></span></button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle"
                                    ...
                                    aria-selected="false"><span class="generator-icon"><img
                                            ...
                                            alt="Vedio Generator Icon">Photo Generator</span><span
                                        class="border-bottom-style"></span></button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle" id="text-generator-tab"
                                    ...
                                    aria-controls="text-generate" aria-selected="false"><span class="generator-icon"><img
                                            ...
                                            alt="Vedio Generator Icon">Text Generator</span><span
                                        class="border-bottom-style"></span></button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle" id="code-generator-tab"
                                    ...
                                    aria-controls="code-generate" aria-selected="false"><span class="generator-icon"><img
                                            ...
                                            alt="Vedio Generator Icon">Code Generator</span><span
                                        class="border-bottom-style"></span></button>
                            </li>
                        </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="section-title">
                                                <h2 class="title">Video generating AI refers to artificial intelligence.
                                                </h2>
                                                <div class="features-section">
                                                    <ul class="list-style--1">
                                                        <li><i class="fa-regular fa-circle-check"></i>Transformer Models
                                                        </li>
                                                        <li><i class="fa-regular fa-circle-check"></i>Conditional
                                                            Generative Models</li>
                                                        <li><i class="fa-regular fa-circle-check"></i>Pre-trained Models
                                                        </li>
                                                ...
                                                <div class="read-more"><a class="btn-default color-blacked"
                                                        href="index.html#">Start Exploring Now <i
                            ...
                            <div class="tab-pane fade show active" id="audio-generate" role="tabpanel"
                                ...
                                <div class="inner">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="section-title">
                                                <h2 class="title">Audio generating AI refers to artificial intelligence.
                                                </h2>
                                                <div class="features-section">
                                                    <ul class="list-style--1">
                                                        <li><i class="fa-regular fa-circle-check"></i>Transformer Models
                            ...
                            <div class="tab-pane fade" id="photo-generate" role="tabpanel"
                                ...
                                <div class="inner">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="section-title">
                                                <h2 class="title">Photo generating AI refers to artificial intelligence.
                                                </h2>
                                                <div class="features-section">
                                                    <ul class="list-style--1">
                                                        <li><i class="fa-regular fa-circle-check"></i>Transformer Models
                            ...
                            <div class="tab-pane fade" id="text-generate" role="tabpanel"
                                ...
                                <div class="inner">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="section-title">
                                                <h2 class="title">Text generating AI refers to artificial intelligence.
                                                </h2>
                                                <div class="features-section">
                                                    <ul class="list-style--1">
                                                        <li><i class="fa-regular fa-circle-check"></i>Transformer Models
                            ...
                            <div class="tab-pane fade" id="code-generate" role="tabpanel"
                                ...
                                <div class="inner">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="section-title">
                                                <h2 class="title">Code generating AI refers to artificial intelligence.
                                                </h2>
                                                <div class="features-section">
                                                    <ul class="list-style--1">
                                                        <li><i class="fa-regular fa-circle-check"></i>Transformer Models
                            ...
                            <div class="rainbow-box-card card-style-default aiwave-service-default has-bg-shaped">
                                <div class="inner">
                                    ...
                                    <div class="description centered-shape">
                                        ...
                                        <p class="desc">Lets users quickly find answers to their questions without having
                                            to search through multiple sources.</p>
                                        <a class="read-more-btn" href="index.html#">Explore More <span><i
                                            ...
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Dentify the platform
                                                        or interface through which you can access the chatbot. This could be
                                                        a website, a messaging app, or a dedicated application.</p>
                                                    <div class="view-more-button mt--35 sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="400">
                                                        <a class="btn-default color-blacked" href="contact.html">Try It
                                                            Now <i class="fa-sharp fa-light fa-arrow-right ml--5"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        ...
                                                        Workflow</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Discover tools and
                                                        techniques to optimize your workflow, making your tasks more
                                            ...
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        ...
                                                        Digital Presence</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Gain insights into
                                                        cybersecurity measures and strategies to safeguard your online
                                                        identity and sensitive information.</p>
                                                    <div class="view-more-button mt--35 sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="400">
                                                        <a class="btn-default color-blacked" href="contact.html">Try It
                                                            Now <i class="fa-sharp fa-light fa-arrow-right ml--5"></i></a>
                                        ...
                                        <div class="row g-0 radius-10 align-items-center">
                                            ...
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="200">Demystifying Data
                                                        Analytics</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Learn the
                                                        fundamentals of data analysis, including tools and methodologies, to
                                                        extract meaningful insights from raw data.</p>
                                                    <div class="view-more-button mt--35 sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="400">
                                                        <a class="btn-default color-blacked" href="contact.html">Try It
                                                            Now <i class="fa-sharp fa-light fa-arrow-right ml--5"></i></a>
                        ...
                        <div class="advance-tab-button advance-tab-button-1 right-top">
                            <ul class="nav nav-tabs tab-button-list" id="myTab-3" role="tablist">
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="index.html#" class="nav-link tab-button active" id="home-tab-3"
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="index.html#" class="nav-link tab-button" id="profile-tab-3"
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="index.html#" class="nav-link tab-button" id="contact-tab-3"
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="index.html#" class="nav-link tab-button" id="explore-tab-3"
                ...
                <div class="col-lg-8">
                    <div class="inner">
                        <div class="content text-left">
                            ...
                            <p class="sal-animate" data-sal="slide-up" data-sal-duration="400" data-sal-delay="300">Meet
                                and learn from 80+ creators & companies who share how thay use AI to create better content
                ...
                <div class="col-lg-4">
                    <div class="right-content">
                        <div class="call-to-btn text-start text-lg-end sal-animate" data-sal="slide-up"
                            ...
                            <a class="btn-default" href="index.html#">Join Now Today Free</a>
                        </div>
                    </div>
                </div>
                <div class="bg-shape">
                            ...
                            <div class="rainbow-pricing style-aiwave">
                                <div class="pricing-table-inner">
                                    ...
                                    <div class="pricing-footer">
                                        <a class="btn-default btn-border" href="index.html#">Get Started</a>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 mt--40">
                            <div class="rainbow-pricing style-aiwave active">
                                <div class="pricing-table-inner">
                                    ...
                                    <div class="pricing-footer">
                                        <a class="btn-default color-blacked" href="index.html#">Get Started</a>
                                        <p class="bottom-text">Limited Offer</p>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 aiwave-style text-center">
                        ...
                        <div class="content">
                            ...
                            <p class="description b1 mb--0">Passages there are many variations variations of of Lorem Ipsum
                                available.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="slide-single-layout">
                            <div class="rainbow-box-card active card-style-default testimonial-style-defalt has-bg-shaped">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <p class="description">Pixcels-Themes has become such an integral part of our work!
                                            By putting our</p>
                        ...
                        <div class="slide-single-layout">
                            <div class="rainbow-box-card card-style-default testimonial-style-defalt has-bg-shaped">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <p class="description">Pixcels-Themes has become such an integral part of our
                                            work! By putting our</p>
                                        <div class="bottom-content">
                                            <div class="meta-info-section">
                                                <p class="title-text">Guy Hawkins</p>
                                                <p class="desc">Nursing Assistant</p>
            ...
            <div class="row">
                <div class="col-lg-12 mt--10">
                    <ul class="brand-list brand-style-2">
                        <li><a href="index.html#"><img src="{{ asset('assets/images/brand/brand-01.png') }}"
                                    alt="Brand Image"></a></li>
                        <li><a href="index.html#"><img src="{{ asset('assets/images/brand/brand-02.png') }}"
                                    alt="Brand Image"></a></li>
                        <li><a href="index.html#"><img src="{{ asset('assets/images/brand/brand-03.png') }}"
                                    alt="Brand Image"></a></li>
                        <li><a href="index.html#"><img src="{{ asset('assets/images/brand/brand-04.png') }}"
                                    alt="Brand Image"></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="inner">
                            <div class="content-left">
                                ...
                                <div class="app-store-btn">
                                    <a class="store-btn" href="index.html#">
